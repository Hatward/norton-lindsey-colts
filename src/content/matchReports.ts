...
export const matchReports: MatchReport[] = [
  {
    ...
    body: [
      ...
      "Hugo was everywhere, and it was brilliant to see him get his rewards with two well-taken goals. Last week he created chance after chance without quite pulling the trigger — this week he backed himself and finished. Roman was strong in defence all afternoon, continuing to improve week on week, and played some really good passes out from the back.",
